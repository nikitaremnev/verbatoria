...
class ActivitySuggestDialog : DialogFragment() {

    companion object {

        fun build(init: Builder.() -> Unit): ActivitySuggestDialog = Builder(init).build()
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog =
        AlertDialog.Builder(activity)
            .apply {
                clickListener = activity as? OnClickSuggestDialogListener
                cancelListener = activity as? OnCancelSuggestDialogListener
