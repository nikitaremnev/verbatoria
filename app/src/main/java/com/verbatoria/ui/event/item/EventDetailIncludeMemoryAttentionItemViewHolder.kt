...
interface EventDetailIncludeMemoryAttentionItemViewHolder {
...
class EventDetailIncludeMemoryAttentionItemViewHolderImpl(
    view: View,
    callback: EventDetailClientItemViewHolder.Callback
) : RecyclerView.ViewHolder(view),
    EventDetailIncludeMemoryAttentionItemViewHolder {
