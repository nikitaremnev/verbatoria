...
import static com.verbatoria.ui.calendar.view.add.clients.ClientsActivity.EXTRA_CLIENT_MODEL;
...
//    private boolean mSearchByPhone;
    ...
    public void createClient() {
        ...
        mClientView.showProgress();
        addSubscription(mClientsInteractor.addClient(mClientModel)
                .doOnComplete(() -> mClientView.hideProgress())
