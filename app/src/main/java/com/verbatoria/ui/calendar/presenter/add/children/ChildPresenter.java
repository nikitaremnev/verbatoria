...
import static com.verbatoria.ui.calendar.view.add.children.ChildActivity.EXTRA_CHILD_MODEL;
import static com.verbatoria.ui.calendar.view.add.children.ChildActivity.EXTRA_CLIENT_MODEL;
...
public class ChildPresenter extends BasePresenter implements IChildPresenter {
    ...
    public void createChild() {
        ...
        if (isChildValid()) {
            childView.showProgress();
            addSubscription(childrenInteractor.addChild(childModel)
                    .doOnComplete(() -> childView.hideProgress())
                    .subscribe(
                            (childModel) -> {
